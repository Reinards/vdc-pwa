  ...
  return (
    <DefaultLayout headerUrl="/img4.jpg">
      ...
      <Head>
        ...
        <div className="mc">
            <h1 className="tc f4 f2-l mt0">Atsauksmes</h1>
            <section>
                ...
                <p className="paragraph1 m2">/Elīna/</p>
            </section>

            <section className="mt3 mt5-l">
                <p className="paragraph1">
                ...
                <p className="paragraph1 m2">/Anete/</p>
            </section>
            ...
            <section className="mt3 mt5-l">
                ...
                <p className="paragraph1 m2">/Linda/</p>
            </section>
            ...
            <section className="mt3 mt5-l">
                ...
                <p className="paragraph1 m2">/Agnese/</p>
            </section>
            ...
            <section className="mt3 mt5-l">
                ...
                <p className="paragraph1 m2">/Laura/</p>
            </section>
        </div>
